...
const AboutPage = () => (
  <section id="about" className="page py-12 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
    <div className="text-center mb-12">
      <h1 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
        About <span className="text-blue-600">Communication Styles</span>
      </h1>
      <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
        Discover how our <strong>communication styles quiz</strong> and <strong>communication style assessment</strong> can help you improve communication skills, strengthen workplace relationships, and unlock your unique communication strengths.
      </p>
    </div>
    ...
    <div className="grid md:grid-cols-2 gap-8 mb-8">
      <Card className="md:p-8">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">The Science Behind It</h2>
    ...
    <Card className="md:p-8">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-800">Dr. Johnson</h3>
        ...
        <div className="text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-800">Emily Rodriguez</h3>
