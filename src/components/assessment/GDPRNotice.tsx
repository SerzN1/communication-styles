...
const GDPRNotice: FunctionComponent = () => {
  ...
  return (
    <div className="fixed bottom-0 sm:bottom-4 left-0 right-0 z-50 flex justify-center pointer-events-none">
      <div className="bg-white border border-gray-300 shadow-lg rounded-lg p-3 flex items-center gap-3 max-w-md w-full pointer-events-auto fade-in">
        <span className="text-gray-700 text-sm">
          This site stores your assessment answers locally in your browser to show your results. No data is sent to a server. <span className="font-medium">Your privacy is respected.</span>
        </span>
        <button
