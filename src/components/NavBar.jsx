                ...
                <ul>
                    <li>
                        <Link to="/" onClick={() => setMobileOpen(false)}
                              className={`block text-sm px-2 py-4 ${isActive('/') ? 'bg-blue-500 text-white' : 'hover:bg-blue-500 hover:text-white'} transition duration-300`}>
                            Home
                        </Link>
                    </li>
                    <li>
                    ...
                    <li>
                        <Link to="/about" onClick={() => setMobileOpen(false)}
                              className={`block text-sm px-2 py-4 ${isActive('/about') ? 'bg-blue-500 text-white' : 'hover:bg-blue-500 hover:text-white'} transition duration-300`}>
                            About
                        </Link>
                    </li>
                </ul>
